...
export default function TrackerSummary({ card, transactions }) {
  ...
  return (
    <div className="sticky top-[57px] z-30 bg-gray-900/95 backdrop-blur border-b border-gray-700 px-4 py-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-3 gap-4">
          <StatBox label="Total Charged" value={totalSpent} colorClass="text-white" />
          <StatBox label="Total Paid" value={totalPaid} colorClass="text-green-400" />
          <StatBox label="Outstanding" value={totalRemaining} colorClass="text-red-400" />
        </div>
      </div>
    </div>
  )
